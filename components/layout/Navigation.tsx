...
const departments = [
  {
    name: 'Tobacco Pipes',
    slug: 'tobacco-pipes',
    subcategories: ['Estate Pipes', 'Briar Pipes', 'Meerschaum', 'Corncob', 'Churchwarden'],
    desc: 'A lifetime of smoke, captured in wood and stone.',
  },
  {
    name: 'Pipe Tobacco',
    slug: 'pipe-tobacco',
    subcategories: ['Virginia Blends', 'Burley & Dark', 'Latakia', 'Aromatic', 'Bulk Tobacco'],
    desc: 'From bright Virginias to smoky Latakia — the full spectrum.',
  },
  {
    name: 'Cigars',
    slug: 'cigars',
    subcategories: ['Premium Hand-Rolled', 'Bundles', 'Samplers', 'Cigar Accessories'],
    desc: 'Hand-rolled excellence, from leaf to light.',
  },
  {
    name: 'Pipe Accessories',
    slug: 'pipe-accessories',
    subcategories: ['Pipe Tools', 'Cleaners & Filters', 'Stands & Racks', 'Pouches', 'Tampers'],
    desc: 'Everything the discerning pipe man requires.',
  },
  {
    name: 'Cigar Accessories',
    slug: 'cigar-accessories',
    subcategories: ['Cutters', 'Lighters', 'Humidors', 'Ashtrays', 'Travel Cases'],
    desc: 'The proper accoutrements for the serious aficionado.',
  },
  {
    name: 'Leather Bags & Cases',
    slug: 'leather-bags',
    subcategories: ['Pipe Bags', 'Cigar Cases', 'Combo Carry Bags', 'Travel Sets'],
    desc: 'Handcrafted leather — built to accompany a lifetime of smoke.',
  },
  {
    name: 'Vaping & E-Liquids',
    slug: 'vaping',
    subcategories: ['Vape Devices', 'Replacement Coils', 'E-Liquids', 'Starter Kits'],
    desc: 'Modern vapor, curated with the same care as our tobaccos.',
  },
  {
    name: 'Lighters & Matches',
    slug: 'lighters',
    subcategories: ['Pipe Lighters', 'Torch Lighters', 'Cedar Spills', 'Matchbooks'],
